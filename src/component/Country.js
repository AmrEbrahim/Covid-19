...
import { fetchCountryData, fetchCountry10Days, fetchCountry30Days } from '../actions';
...
const Country = ({
    ...
    }, [match.params.id, fetchCountryData, fetchCountry10Days, fetchCountry30Days, history]);
